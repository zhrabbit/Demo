...
folder are mapped to the application's root namespace, 'TrainProjectServer'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "TrainProjectServer"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'TrainProjectServer' in the same way
as `"TrainProjectServer/sass/src"`.
